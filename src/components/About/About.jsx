        ...
        <div className="about-container">
          ...
          <section className="about-hero">
            ...
            >
              ...
              <div className="hero-title">
                Fresh Graduate with a Passion for Building Modern Web
                Applications.
              </div>

              <p className="hero-description">
                Hello! I'm <strong>John Matthew R. Malabanan</strong>, a fresh
                graduate with a Bachelor of Science in Information Technology
                from Romblon State University – San Fernando Campus.
              </p>

              <p className="hero-description">
                I enjoy designing and developing responsive, user-friendly, and
                scalable web applications. My primary focus is Full Stack Web
                Development, where I combine frontend design with backend
                development to create complete digital solutions. I believe
            ...
            >
              <div className="profile-card">
                <div className="profile-item">
                  ...
                  <div className="profile-value">Fresh Graduate</div>
                </div>

                <div className="profile-item">
                  <span className="profile-label">Degree</span>

                  <div className="profile-value">BS Information Technology</div>
                </div>
                ...
                <div className="profile-item">
                  <span className="profile-label">Current Goal</span>
          ...
          <section className="values-section">
            ...
            <p className="section-description">
              The principles that guide how I learn, build software, and
              continuously grow as an aspiring Full Stack Web Developer.
            </p>
          ...
          <section className="education-section">
            ...
            >
              ...
              <p className="section-description">
                ...
                information technology, software development, and continuous
                learning.
              </p>
            </motion.div>
              ...
              {education.map((item, index) => (
                ...
                >
                  ...
                  <div className="education-content">
                    <div className="education-level">{item.level}</div>
          ...
          <section className="journey-section">
            ...
            >
              <div className="section-title">My Developer Journey</div>

              <p className="section-description">
                Every step of my journey has contributed to the developer I am
                today. From writing my first line of code to building real-world
                systems, each experience strengthened my passion for software
                development.
              </p>
            </motion.div>
          ...
          >
            <div className="closing-card">
              ...
              <div className="closing-title">
                Building software that creates value while continuously growing
                as a developer.
              </div>

              <p>
                I may be at the beginning of my professional career, but I bring
                curiosity, dedication, adaptability, and a genuine passion for
                technology. I am excited to contribute to meaningful projects,
                collaborate with experienced professionals, and continue
                learning every day as I pursue a long-term career in Full Stack
                Web Development.
              </p>
            </div>
          </motion.section>
