...
const experiences = [
  {
    ...
    company: "Lead Developer & Research Leader",
...

  {
    ...
    description:
      "Collaborated with a fellow developer to design, develop, and deploy the Document Administration and Control System (DACS) within a three-month internship at the City Government of Makati. Primarily responsible for frontend development, UI/UX design, and responsive user interfaces using HTML, CSS, JavaScript, PHP, and MySQL, while supporting backend development when needed. Worked closely with the backend developer to deliver a complete document management solution, which was successfully deployed to the organization's production server and is now used for daily government document tracking and routing operations.",
        ...
        <div className="experience-container">
          ...
          >
            ...
            <div className="experience-description">
              A collection of my internship experience, academic projects,
              certifications, and real-world software development journey as I
              continue growing as a Full Stack Web Developer.
            </div>
          </motion.div>
          ...
          <div className="experience-stats">
            {stats.map((item, index) => (
              ...
              >
                <div className="experience-stat-icon">{item.icon}</div>

                <div className="experience-stat-number">{item.number}</div>

                <div className="experience-stat-title">{item.title}</div>

                <div className="experience-stat-subtitle">{item.subtitle}</div>
              </motion.div>
            ))}
          </div>
                ...
                <div className="experience-card">
                  <div className="experience-card-header">
                    <div className="experience-company">
                      <div className="experience-company-icon">{item.icon}</div>

                      <div className="experience-company-info">
                        <div className="experience-position">{item.title}</div>
          ...
          >
            <div className="certificates-header">
              ...
              <p className="certificates-description">
                ...
                that reflect my commitment to expanding my technical knowledge
                and advancing my software development skills.
              </p>
            </div>
          ...
          >
            ...
            <div className="experience-footer-description">
              From academic projects to real-world internship experience, I
              continuously improve my technical skills, problem-solving ability,
              and passion for developing modern web applications.
            </div>
          </motion.div>
        </div>
      </section>
